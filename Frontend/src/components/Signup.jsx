...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios
      .post("it-books-ghh3.vercel.app/user/signup", userInfo)
      .then((res) => {
  ...
  return (
    <>
      <div className="  background1 flex h-screen items-center justify-center">
          ...
          <div className="modal-box">
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <div className="mt-4 space-y-2 dark:text-black">
                ...
                <br />
                {errors.password && (
                  <span className="text-sm text-red-500 dark:text-black">
                    This field is required
                  </span>
                )}
              </div>
